...
<form action="{{ route('locations.update', $location) }}" method="POST" class="mt-3" id="locationForm">
    @csrf
    @method('PUT')
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-4" id="loc-code">
            ...
            <input type="text" name="code" class="form-control" required value="{{ $location->code }}">
        </div>
    ...
    <div class="row g-3 mb-3" id="loc-details">
        <div class="col-md-2">
            ...
            <input type="text" name="aisle" class="form-control" value="{{ $location->aisle }}">
        </div>
        <div class="col-md-2">
            <label class="form-label">Estante</label>
            <input type="text" name="shelf" class="form-control" value="{{ $location->shelf }}">
        </div>
        <div class="col-md-2">
            <label class="form-label">Anaquel</label>
            <input type="text" name="rack" class="form-control" value="{{ $location->rack }}">
        </div>
        <div class="col-md-2">
            <label class="form-label">Cajón</label>
            <input type="text" name="bin" class="form-control" value="{{ $location->bin }}">
        </div>
        <div class="col-md-2">
            <label class="form-label">Vitrina/Sección</label>
            <input type="text" name="section" class="form-control" value="{{ $location->section }}">
        </div>
    </div>
    ...
    <div class="form-check mb-3" id="loc-active">
        <input type="checkbox" name="is_active" class="form-check-input" id="is_active" {{ $location->is_active ? 'checked' : '' }} value="1">
